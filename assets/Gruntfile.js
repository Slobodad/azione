	...
	uglify: {
		dist: {
			files: {
				...
				'../markup/js/fancybox.min.js': ['dist/js/plugin/fancybox.js'],

				'../markup/js/script.min.js': ['dist/js/script.js'],
				'../markup/js/home.min.js': ['dist/js/home.js'],
				'../markup/js/search-results.min.js': ['dist/js/search-results.js'],
				'../markup/js/stock.min.js': ['dist/js/stock.js'],
				'../markup/js/stock-internal.min.js': ['dist/js/stock-internal.js'],
				'../markup/js/delivery.min.js': ['dist/js/delivery.js'],
				'../markup/js/product-card.min.js': ['dist/js/product-card.js'],
				'../markup/js/categories.min.js': ['dist/js/categories.js'],
				'../markup/js/contact.min.js': ['dist/js/contact.js'],
				'../markup/js/personal-area.min.js': ['dist/js/personal-area.js'],
				'../markup/js/order.min.js': ['dist/js/order.js'],
